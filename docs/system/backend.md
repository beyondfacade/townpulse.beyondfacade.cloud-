---
layout: default
title: 2) AI·백엔드 기술 구조
permalink: /docs/system/backend.html
parent: 3. 시스템 구조
nav_order: 2
---
...
> 💡 **쉽게 말하면**: AI는 처방을 "설명하는 글"만 씁니다. 예산이나 점수 같은 숫자는 미리 검증된 계산기가 냅니다. 그래서 AI가 숫자를 지어내는 일이 구조적으로 막힙니다. 코드는 도메인마다 똑같은 11개 파일 세트로 반복되는 "프랙탈" 구조라, 새 기능을 붙이거나 지역을 넓힐 때 같은 패턴만 따르면 됩니다.
