---
layout: default
title: 1) 공공데이터 활용 — 19종 API
permalink: /docs/data-method/public-data.html
parent: 2. 데이터와 방법론
nav_order: 1
---
...
> 💡 **쉽게 말하면**: 인구·건물·에너지·버스·통계·의료·교육을 각각 다른 기관이 따로 공개합니다. 그 19곳의 데이터를 한 파이프라인으로 모아, 마을(읍·면·동)마다 한 줄로 정리한 "스냅샷"을 만듭니다. 아래 표는 어느 데이터의 어떤 값이 우리 DB의 어느 칸에 들어가는지를 정리한 것입니다.
...
## SNAP 테이블별 JSON 키 ↔ DB 컬럼 매핑 (검증 완료)
